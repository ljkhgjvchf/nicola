      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground font-light max-w-3xl mx-auto mb-12 leading-relaxed">
            Book a free 15-minute consultation to discover how AI automation can 
            revolutionize your operations, save time, and increase revenue.
          </p>

          <Button
            onClick={handleBookCall}
            className="glow-button bg-primary hover:bg-primary/90 text-primary-foreground px-12 py-6 text-xl font-medium rounded-full"
            size="lg"
          >
