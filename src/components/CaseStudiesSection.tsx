  ...
  const caseStudies = [
    {
      ...
      achievements: [
        "Average conversations per month: +325",
        "Helped +145 companies find the best funding",
        "Saving +60 hrs a month"
      ],
    ...
    },
    {
      ...
      achievements: [
        "Handle +95 calls monthly",
        "Working 24/7 even when owner is on holiday",
        "100% appointment accuracy"
      ],
    ...
    },
    {
      ...
      achievements: [
        "Generate +1000 new potential leads per month",
        "CR (Conversion Rate) 10%",
        "Client sales 200K after 1st month"
      ],
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground font-light max-w-3xl mx-auto">
            Real results from real clients who transformed their business with AI automation
          </p>
        </motion.div>
